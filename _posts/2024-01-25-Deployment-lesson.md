...
3. **Validation and Restart:**
   - Create a symbolic link to /etc/nginx/sites-enabled: `ln -s /etc/nginx/conf-available/your-server-name /etc/nginx/conf-enabled`
...
![](https://the-gpt-warriors.github.io/DeploymentLesson/images/dns.png)

![](https://the-gpt-warriors.github.io/DeploymentLesson/images/route53.png)
...
![](https://the-gpt-warriors.github.io/DeploymentLesson/images/dnsprocess.png)
...
![](https://the-gpt-warriors.github.io/DeploymentLesson/images/nginx.png)
...
![](https://the-gpt-warriors.github.io/DeploymentLesson/images/certbot.png)
